...
private:
    ...
    std::string currentSceneName;              ///< The identifier of the currently active scene.
...
public:
    ...
    /**
     * @brief Gets the identifier of the currently active scene.
     *
     * @return Scene name such as "level_01".
     */
